...
namespace EmployeePayRollService
{
    class EmployeeRepo
    {
        public static string connectionString = @"Data Source=LAPTOP-Q7383BB0\SQLEXPRESS;Initial Catalog=emppayroll_service;Integrated Security=True";
        ...
        public void GetAllEmployee()
        {
            try
            {
                ...
                {
                    string query = @"Select * from employee_payrollservice;";
